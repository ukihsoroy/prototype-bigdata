            ...
            if(input == null) {
                ...
                if(ctx.mode != 1) {
                    for(output = new byte[16]; length > 0; length -= 16) {
                        ...
                        this.sm4OneRound(ctx.sk, in, out);
